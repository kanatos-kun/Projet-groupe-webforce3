...
<?php $this->start('main_content') ?>
	...
	<link rel="stylesheet" type="text/css" href="css/Dashboard utilisateur.css"/>
	...
	<div class="container-fluid">
		...
		<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
			<ul>
				...
				<li><a class="Projets" href="#">Projets</a></li>
				<li><a class="Formations" href="#">Formations</a></li>
				<li><a class="Profil" href="profile.html">Profil</a></li>
				<li><a class="Deconnexion" href="#">Deconnexion</a></li>
			</ul>
		</div>
</nav>
	...
	<section class="row row1">
		...
		<div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
			<div class="small-box bg-purple">
				...
				<a href="#" class="small-box-footer minFooter">More info <i class="fa fa-arrow-circle-right"></i></a>
			</div>
		</div>
		<div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
			<!-- small box -->
...
<section class="row row3">
	...
	<div class="col-xs-12">
		<article class="news-feed__usage">
...
<section class="row row4">
	...
	<div class="col-xs-12 col-sm-12 col-md-5">
		<div class="row row6">
			...
			<div class="col-xs-12" id="usersInfo">
			...
			<div class="col-xs-12" id="userSearch">
				...
				<form class="navbar-form navbar-left">
			        <div class="form-group">
			          <input type="text" class="form-control" placeholder="Adresse/Ville/Code Postal">
			        </div>
                	...
                	<div class="row row7">
                		<div class="col-xs-12 col-sm-6 col-md-3">
                			<ul class="users-list clearfix">
                				<li>
                					<img src="img/128x128.jpg" alt="User Image">
			...
			<div class="box-header ui-sortable-handle" style="cursor: move;">
				...
				<div class="box-body">
					<form action="#" method="post">
						...
						<iframe class="wysihtml5-sandbox" security="restricted" allowtransparency="true" marginwidth="0" marginheight="0" width="0" height="0" frameborder="0"></iframe>

						<div class="textarea wysihtml5-editor placeholder" spellcheck="true" style="background-color: rgb(255, 255, 255); color: rgb(51, 51, 51); cursor: text; font-family: &quot;Source Sans Pro&quot;,&quot;Helvetica Neue&quot;,Helvetica,Arial,sans-serif; font-size: 14px; font-style: normal; font-variant: normal; font-weight: 400; line-height: 18px; letter-spacing: normal; text-align: start; text-decoration: none; text-indent: 0px; text-rendering: optimizelegibility; word-break: normal; overflow-wrap: break-word; word-spacing: 0px;" contenteditable="true">Message</div>
