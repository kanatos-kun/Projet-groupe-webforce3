...
$w_config = [
    ...
    'db_name' => 'base_de_donnee_projet_wf3',								//nom de la bdd
    'db_table_prefix' => '',						//préfixe ajouté aux noms de table

	//authentification, autorisation
	'security_user_table' => 'utilisateur',				//nom de la table contenant les infos des utilisateurs
	...
	'security_password_property' => 'mot_de_passe',		//nom de la colonne pour le "mot de passe"
	'security_role_property' => 'privileges',				//nom de la colonne pour le "role"

	'security_login_route_name' => 'home',			//nom de la route affichant le formulaire de connexion

	// configuration globale
	'site_name'	=> 'Website_projet_wf3', 								// contiendra le nom du site
];
